                    ...
                    <div className="w-full surface-card py-5 px-5 sm:px-8" style={{ borderRadius: '33px' }}>
                        ...
                        <div>
                            {/* <span className="p-float-label mb-5">
                                <InputText className="w-full" type="text" id="inputtext1" value={''} onChange={(e) => setValue1(e.target.value)} />
                                <label htmlFor="inputtext">InputText</label>
                            </span>
                            <span className="p-float-label mb-5">
                                <InputText className="w-full" type="text" id="inputtext2" value={''} onChange={(e) => setValue1(e.target.value)} />
                                <label htmlFor="inputtext">InputText</label>
                            </span> */}
                            {/* <label htmlFor="email1" className="block text-900 text-xl font-medium mb-2">
                                Email
                            </label> */}
                            <InputText inputid="email1" type="text" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Email address" className="w-full mb-5" style={{ padding: '1rem' }} />
